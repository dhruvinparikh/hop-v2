...
// forge script src/script/hop/DeployRemoteHopV2Arbitrum.s.sol --rpc-url https://arbitrum.public.blockpi.network/v1/rpc/public --broadcast --verify --verifier etherscan --etherscan-api-key $ARBISCAN_API_KEY
