...
// forge script src/script/hop/DeployRemoteHopV2Berachain.s.sol --rpc-url https://rpc.berachain.com --broadcast --verify --verifier etherscan --etherscan-api-key $ETHERSCAN_API_KEY --gcp --sender 0x54f9b12743a7deec0ea48721683cbebedc6e17bc
contract DeployRemoteHopV2Berachain is DeployRemoteHopV2 {
    constructor() {
        proxyAdmin = 0x223a681fc5c5522c85C96157c0efA18cd6c5405c;
        endpoint = 0x6F475642a6e85809B1c36Fa62763669b1b48DD5B;
        localEid = 30_362;

        msig = 0x436b303dAf4b95e94ad86cA3821d5E50eB0De3aA;
